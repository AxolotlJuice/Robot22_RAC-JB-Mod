...
public class ShootFirst_JBMod_2R extends CommandBase
{
	 ...
	 */
	public ShootFirst_JBMod(DriveBase subsystem, Shooter shooter, Channel channel, Pose2d startingPose) 
	{
	...
	public void initialize() 
	{
		...
		//rotate: 314 to 111 (clockwise)

		//Drive: (x:8.830, y:5.893)
		//       (x:8.564, y:7.166) distance: 1.30049413686 m.

		//rotate: 111 to 314 (counter-clockwise)
		
		//Drive: 1.30049413686 m.
